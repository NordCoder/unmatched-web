...
type SchemeFighterActionView struct {
	...
	TargetsByDestination map[string][]string `json:"targets_by_destination,omitempty"`
}

type SchemeActionView struct {
	Fighters []SchemeFighterActionView `json:"fighters,omitempty"`
}
