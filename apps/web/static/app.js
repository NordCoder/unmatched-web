...
function ownLivingFighters(){return allFighters().filter(f=>f.owner_id===view.viewing_player_id&&!f.defeated)}
function opposingLivingFighters(){return allFighters().filter(f=>f.owner_id!==view.viewing_player_id&&!f.defeated)}
