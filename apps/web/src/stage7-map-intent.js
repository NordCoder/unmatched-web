(function(global){
  ...
  function install(){
    ...
    boardHighlights=function(){
      ...
      if(interaction.mode!=='fighter_selected')return result;
    ...
    renderBoard=function(){
      ...
      const board=$('board');
      if(!board)return;
      board.dataset.interactionMode=interaction.mode==='fighter_selected'?'fighter-intent':'';
    ...
    renderActions=function(){
      ...
      $('stage7-start-maneuver').onclick=startManeuver;
    };
